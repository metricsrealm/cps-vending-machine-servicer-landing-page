...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#0B2A5B]/96 backdrop-blur-[8px] border-b border-white/8" id="site-header">
      <div className="max-w-7xl mx-auto px-6 h-[88px] flex items-center justify-between" id="header-container">
        {/* Logo Section */}
        <a 
          href="#" 
        ...
        >
          {!logoFailed ? (
            ...
            <div className="flex flex-col" id="header-logo-fallback">
              <span className="font-display font-extrabold text-white text-[18px] tracking-[0.02em] leading-[1.05]" id="header-logo-fallback-title">
                CPS
              </span>
              <span className="text-[10px] font-semibold tracking-[0.18em] text-[#9fb3d1] uppercase leading-none mt-1" id="header-logo-fallback-sub">
                MARKETS & VENDING
              </span>
            </div>
          )}
        ...
        {/* Action Items */}
        <div className="flex items-center gap-[18px]" id="header-actions-wrapper">
          {/* Phone Link */}
          <a 
          ...
          >
            <Phone className="h-[20px] w-[20px] text-orange flex-shrink-0" aria-hidden="true" id="header-phone-icon" />
            <div className="flex flex-col text-left" id="header-phone-text-group">
              <span className="text-[12px] font-medium text-[#9fb3d1] leading-none" id="header-phone-label">Call Local</span>
              <span className="font-display font-bold text-[16px] tracking-wide mt-0.5" id="header-phone-number">(385) 208-4074</span>
            </div>
          </a>
