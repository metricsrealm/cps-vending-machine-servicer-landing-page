...
export default function RepairServiceArea() {
  ...
  return (
    <section className="bg-white py-[78px]" id="service-area-section">
      <div className="max-w-[1200px] mx-auto px-6 text-center">
        {/* Pin Icon */}
        <div className="w-[52px] h-[52px] rounded-full bg-[#FFF3E9] text-orange flex items-center justify-center mx-auto mb-4">
        ...
        {/* City Pills Grid */}
        <div className="flex flex-wrap gap-[10px] justify-center max-w-[820px] mx-auto mt-[26px]">
          {cities.map((city, idx) => (
            <button
              key={idx}
          ...
          <AnimatePresence mode="wait">
            {selectedCity && (
              ...
              >
                ...
                <span>Yes, our service technicians support <span className="font-bold text-orange">{selectedCity}</span> businesses!</span>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
        ...
        {/* Action Bottom */}
        <div className="area-call mt-[34px]">
          <p className="font-sans font-semibold text-[#5B6472] text-[16px] mb-3.5">
