...
export default function RepairReviews() {
  ...
  return (
    <section className="bg-white py-12 md:py-16" id="reviews-section">
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-10 text-left max-w-5xl mx-auto border-b border-line/60 pb-8">
          ...
          <div className="flex-shrink-0 self-start md:self-center">
            <div className="inline-flex items-center gap-[14px] bg-[#FAF8F5] border border-line rounded-[14px] px-5 py-3.5 shadow-sm">
